...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'my_resume.context_processors.project_context'
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'portfolio_db_blj4_chsm',
        'USER': 'samukele',
        'PASSWORD': 'ETG1moBaVuNLQQYEEvfdqj8Zd5vneTsZ',
        'HOST': 'dpg-cn9pven109ks739vjcag-a.oregon-postgres.render.com',
    }
}
